...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="{{ asset('avatar/'. auth()->user()->avatar ) }}" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="{{ route('ganti-profile') }}"><i class="material-icons">person</i>Profile</a>
                            </li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; {{ date('Y') }} <a href="javascript:void(0);">Sistem Informasi Bimbel</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.0
                </div>
